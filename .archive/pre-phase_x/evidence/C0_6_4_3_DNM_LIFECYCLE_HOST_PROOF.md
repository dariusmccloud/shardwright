...
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-3.ps1`
...
```text
powershell -ExecutionPolicy Bypass -File .archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-3.ps1 -InstallPayload -RestartHosts
```
