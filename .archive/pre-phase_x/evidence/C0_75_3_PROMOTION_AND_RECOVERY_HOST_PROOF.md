...
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-75-3.ps1`
- `.archive/pre-phase_x/tools/server-plugin/stage-c0-75-proof-fixtures.mjs`
...
```text
powershell -ExecutionPolicy Bypass -File .archive/pre-phase_x/tools/server-plugin/prove-c0-75-3.ps1 -InstallPayload -RestartHosts
```
