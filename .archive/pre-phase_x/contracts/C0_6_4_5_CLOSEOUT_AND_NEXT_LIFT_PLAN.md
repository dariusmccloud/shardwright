...
- verified on 2026-07-07 with `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-5a.ps1`
...
- verified on 2026-07-07 with `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-5b.ps1`
...
3. `powershell -NoProfile -ExecutionPolicy Bypass -File ".archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-5c.ps1" -HostName "SillyTavern" -Port 8000`
