...
- `.archive/pre-phase_x/operational/HOST_SMOKE_TEST_CHECKLIST.md`
...
- `.archive/pre-phase_x/tools/server-plugin/seed-interpretive-candidate.ps1`
- `.archive/pre-phase_x/tools/server-plugin/reset-interpretive-smoke-storage.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-5a.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-5b.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-4-5c.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-7c.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-7c-fresh-install.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-7c-corrected-child.ps1`
- `.archive/pre-phase_x/tools/server-plugin/prove-c0-6-7c-rollback-recovery.ps1`
