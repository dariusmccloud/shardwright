...
const SOURCE_PLUGIN_ROOT = path.join(__dirname, 'shardwright-memory');
...
const STATIC_PAYLOAD_FILES = Object.freeze([
    ...
    'identity.js',
    'membership.js',
    'branch-lineage-ledger.js',
    'branch-lineage-route.js',
    'character-association-audit.js',
    'character-association-audit-route.js',
    'compiled-context-document-projection.js',
    'compiled-context-document-route.js',
    'context-planning-digest-route.js',
    'transcript-anchor-resolution.js',
    'transcript-anchor-resolution-route.js',
    'transcript-branch-discovery.js',
    'transcript-branch-lineage-suggestion.js',
    'transcript-branch-source-sequences.js',
    'transcript-candidate-window-assembly.js',
    'transcript-candidate-window-assembly-route.js',
    'transcript-character-binding.js',
    'transcript-character-binding-registration-route.js',
    'transcript-character-binding-route.js',
    'transcript-context-window.js',
    'transcript-context-window-route.js',
    'transcript-coverage-diagnostic.js',
    'transcript-coverage-diagnostic-route.js',
    'transcript-exact-content-equivalence.js',
    'transcript-fts-candidate-route.js',
    'transcript-fts-candidate-selection.js',
    'transcript-fts-document-projection.js',
    'transcript-incremental-projector.js',
    'transcript-message-ledger.js',
    'transcript-message-parser.js',
    'transcript-projection-route.js',
    'transcript-recall-bundle.js',
    'transcript-recall-bundle-route.js',
    'transcript-source-intake.js',
    'transcript-source-intake-route.js',
    'transcript-source-observer.js',
    'transcript-source-preview.js',
    'transcript-source-registry.js',
    'transcript-source-revision.js',
    'transcript-source-route.js',
    'transcript-visibility-ledger.js',
    'transcript-visibility-projection.js',
...
const RUNTIME_SHARED_ENTRYPOINTS = Object.freeze([
    ...
    'core/compiled-context/document-compiler.js',
    'core/compiled-context/document-source-loader.js',
]);
...
function buildPayloadManifest(sharedEntries, {
    ...
    return {
        pluginId: 'shardwright-memory',
        canonicalRoot: 'core',
        generatedBy: 'tools/server-plugin/package-shardwright-memory.mjs',
...
export function packageShardwrightMemoryPlugin(options = {}) {
...
if (process.argv[1] && path.resolve(process.argv[1]) === __filename) {
    const manifest = packageShardwrightMemoryPlugin();
