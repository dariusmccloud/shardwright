export const PLUGIN_ID = 'shardwright-memory';
...
export function schemaStatements() {
    return [
        ...
        `CREATE TABLE IF NOT EXISTS interpretation_evidence_envelopes (
            interpretation_revision_id TEXT PRIMARY KEY,
            envelope_version INTEGER NOT NULL,
            inspectability_state TEXT NOT NULL,
            created_at INTEGER NOT NULL,
            updated_at INTEGER NOT NULL
        )`,
        `CREATE TABLE IF NOT EXISTS interpretation_evidence_previews (
            interpretation_revision_id TEXT NOT NULL,
            evidence_preview_id TEXT NOT NULL,
            grounding_link_id TEXT NOT NULL,
            basis_type TEXT NOT NULL,
            basis_ref TEXT NOT NULL,
            source_artifact_class TEXT,
            source_revision_identity_json TEXT,
            source_label TEXT NOT NULL,
            speaker_label TEXT,
            context_label TEXT,
            preview_kind TEXT NOT NULL,
            preview_content_json TEXT NOT NULL,
            preview_content_hash TEXT NOT NULL,
            verification_state TEXT NOT NULL,
            created_at INTEGER NOT NULL,
            PRIMARY KEY (interpretation_revision_id, evidence_preview_id)
        )`,
        ...
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_policy_profiles (
            profile_id TEXT NOT NULL,
            policy_version INTEGER NOT NULL,
            policy_hash TEXT NOT NULL,
            subject_entity_id TEXT NOT NULL,
            jurisdiction_scope_id TEXT NOT NULL,
            profile_json TEXT NOT NULL,
            created_at INTEGER NOT NULL,
            PRIMARY KEY (profile_id, policy_version)
        )`,
        `CREATE TABLE IF NOT EXISTS authenticated_semantic_entity_bindings (
            account_handle TEXT PRIMARY KEY,
            semantic_entity_id TEXT NOT NULL UNIQUE,
            binding_hash TEXT NOT NULL,
            bound_by_account_handle TEXT NOT NULL,
            created_at INTEGER NOT NULL
        )`,
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_policy_assignments (
        ...
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_fact_declarations (
            ...
            declaring_entity_id TEXT NOT NULL,
            basis_refs_json TEXT NOT NULL,
            profile_id TEXT NOT NULL,
            policy_version INTEGER NOT NULL,
            policy_hash TEXT NOT NULL,
        ...
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_acknowledgments (
            ...
            evidence_set_hash TEXT NOT NULL,
            proposal_kind TEXT NOT NULL,
            acknowledging_entity_id TEXT NOT NULL,
            acknowledgment_state TEXT NOT NULL,
            recorded_by_entity_id TEXT NOT NULL,
        ...
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_policy_bindings (
            ...
            evidence_set_hash TEXT NOT NULL,
            created_at INTEGER NOT NULL,
            PRIMARY KEY (binding_target_type, binding_target_id)
        )`,
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_fact_attestations (
            binding_target_type TEXT NOT NULL,
            binding_target_id TEXT NOT NULL,
            evidence_set_hash TEXT NOT NULL,
            policy_hash TEXT NOT NULL,
        ...
        `CREATE TABLE IF NOT EXISTS subject_scoped_proposal_eligibility_evaluations (
            binding_target_type TEXT NOT NULL,
            binding_target_id TEXT NOT NULL,
            policy_hash TEXT NOT NULL,
            facts_hash TEXT NOT NULL,
