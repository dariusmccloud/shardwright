...
export async function init(router) {
    ...
    router.post('/interpretive/subject-policy/profiles', async (request, response) => {
        try {
            return response.send(registerSubjectScopedProposalPolicyProfile(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/identity-bindings', async (request, response) => {
        try {
            return response.send(bindAuthenticatedAccountToSemanticEntity(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/assignments', async (request, response) => {
        try {
            return response.send(assignSubjectScopedProposalPolicyProfile(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/fact-declarations', async (request, response) => {
        try {
            return response.send(declareSubjectScopedProposalFact(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/acknowledgments', async (request, response) => {
        try {
            return response.send(recordSubjectScopedProposalAcknowledgment(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/actions/fact-declarations', async (request, response) => {
        try {
            return response.send(declareSubjectScopedProposalFactAsAuthenticatedAccount(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/actions/acknowledgments', async (request, response) => {
        try {
            return response.send(recordSubjectScopedProposalAcknowledgmentAsAuthenticatedAccount(request, request.body || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.get('/interpretive/subject-policy/status', async (request, response) => {
        try {
            return response.send(getSubjectScopedPolicyOperatorStatus(request, request.query || {}));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.get('/interpretive/subject-policy/synthesis/:synthesisRunId/status', async (request, response) => {
        try {
            return response.send(getSubjectScopedSynthesisOperatorStatus(request, request.params.synthesisRunId));
        } catch (error) {
            return handleError(response, error);
        }
    });

    router.post('/interpretive/subject-policy/synthesis/:synthesisRunId/actions/:action', async (request, response) => {
        try {
            return response.send(performAuthenticatedSubjectPolicySynthesisAction(
                request,
                request.params.synthesisRunId,
