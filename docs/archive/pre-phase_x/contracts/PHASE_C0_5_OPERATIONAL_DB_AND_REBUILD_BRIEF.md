...
- `docs/archive/pre-phase_x/contracts/pre-phase_x/COMMIT_1B0_HOST_SUBSTRATE_FEASIBILITY_BRIEF.md`
- `docs/archive/pre-phase_x/contracts/pre-phase_x/PHASE_C0_5_OPERATIONAL_DB_AND_REBUILD_BRIEF.md`
