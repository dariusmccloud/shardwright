...
- `docs/archive/pre-phase_x/evidence/C0_6_INTERPRETIVE_SHARD_INSERTION_REPORT.md`
- `docs/archive/pre-phase_x/fixtures/C0_6_INTERPRETIVE_SOVEREIGNTY_GOLD_FIXTURE.md`
- `docs/archive/pre-phase_x/fixtures/C0_6_CANONICAL_INTERPRETIVE_SHARD_RECORDS.md`
...
- `docs/archive/pre-phase_x/contracts/pre-phase_x/PHASE_C0_6_1_INTERPRETATION_CANDIDATE_SCHEMA_AND_VALIDATION_POLICY_RESOLUTION_BRIEF.md`
- `docs/archive/pre-phase_x/contracts/pre-phase_x/C0_6_1_COMPLETION_REPORT.md`
- `docs/archive/pre-phase_x/contracts/pre-phase_x/PHASE_C0_6_3_BOUNDED_SYNTHESIS_PROPOSAL_GENERATION_AND_GROUNDING_BRIEF.md`
- `docs/archive/pre-phase_x/contracts/pre-phase_x/C0_6_3_COMPLETION_REPORT.md`

Active next sub-slice:

- `docs/archive/pre-phase_x/contracts/pre-phase_x/PHASE_C0_6_4_PUBLICATION_AUTHORITY_AND_PORTABLE_DNM_CONTRACT_BRIEF.md`
