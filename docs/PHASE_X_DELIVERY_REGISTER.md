...
lawful runtime work should be another read-only route over proven replay state or a separately
bounded lock-recovery slice; neither may create new authority or repair missing ledger entries.
