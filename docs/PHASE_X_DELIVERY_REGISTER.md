...
| Capture vocabulary and source policy | [Capture Vocabulary and Source Policy](contracts/PHASE_X_CAPTURE_VOCABULARY_AND_SOURCE_POLICY_CONTRACT.md) | `ENTERED` | No implementation closure recorded | Implement with the capture path, using the closed vocabulary. |
