...
export function installHostCharacterIdentityAssociationCapability({ target = globalThis, contextResolver, writeExtensionField, clearExtensionField, auditDecision } = {}) {
    ...
    namespace.associateCharacterIdentity = async (input = {}) => {
        ...
        const characterId = Number(input.characterId ?? context?.characterId);
    ...
    namespace.associateCurrentCharacterIdentity = async (input = {}) => namespace.associateCharacterIdentity(input);
