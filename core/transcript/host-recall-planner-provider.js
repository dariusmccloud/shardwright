...
export async function planHostTranscriptRecall({ request, transports, posture = 'CONTINUITY', candidateLimit = 50, capacityProfile, cryptoApi, serverDigest } = {}) {
    ...
    const retrieval = await retrieveTranscriptRecall({ request, posture, candidateLimit, transports });
